<script>
  ...
  onMount(() => {
    ...
    import('gsap/ScrollTrigger').then((module) => {
      ...
      // Add scroll parallax after ScrollTrigger is loaded
    ...
    // Main timeline (without title animations)
